      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginBottom: '80px' }}>
          {[
            ...
            { num: '10', icon: <span style={{ fontSize: 24, filter: 'drop-shadow(0 0 10px rgba(56,189,248,0.5))' }}>🧠</span>, title: 'AI Care Workspace', text: 'An immersive, premium roadmap from symptom detection to complete recovery.', color: '#38bdf8', route: '/ai-treatment-journey' },
          ].map((item, idx) => (
